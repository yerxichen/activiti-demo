package cn.yer.activiti.demo.generator;
...
public class MabatisPlusGenerator {
    ...
    //基本包名
    private static String basePackage = "com.sjq.ntnbzhfk";
    //作者
    private static String authorName = "lc";
    //要生成的表名

    private static String[] tables = {"jg_jbxx"};
    //table前缀
    private static String prefix = "T_";
    //数据库配置四要素
    private static String driverName = "oracle.jdbc.driver.OracleDriver";
    private static String url = "jdbc:oracle:thin:@oracle.sjqsoft.com:11521:orcl";
    private static String username = "ntnbzhfk";
    private static String password = "ntnbzhfk";
